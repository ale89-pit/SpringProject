...
CREATE TABLE `competenze` (
  ...
  CONSTRAINT `FKg0l621f4qyp1x8581eit8r6ct` FOREIGN KEY (`id_tipskill`) REFERENCES `tipskill` (`id_tipskill`),
...
CREATE TABLE `curriculum` (
  ...
  KEY `id_dipendente_idx` (`id_dipendente`),
  CONSTRAINT `id_di` FOREIGN KEY (`id_dipendente`) REFERENCES `dipendente` (`id_dipendente`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2023-11-17 12:29:46
